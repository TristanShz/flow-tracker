...
func NewApp(startFlowSessionUseCase start.UseCase, stopFlowSessionUseCase stop.UseCase, flowSessionStatusUseCase status.UseCase, listProjectsUseCase list.UseCase) *App {
	return &App{
